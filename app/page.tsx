          ...
          <div className={`${cardClass} rounded-lg p-6 max-w-2xl w-full border max-h-[90vh] overflow-y-auto`} onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className={`block text-sm ${textSecondary} mb-2`}>Recipient Emails (comma-separated)</label>
                  <input
                    type="text"
                    value={alertConfig.recipient_emails}
                    onChange={(e) => setAlertConfig({...alertConfig, recipient_emails: e.target.value})}
